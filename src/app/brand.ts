...
export const HERO = {
  ...
  headline: 'Сучасна онлайн школа',
  lead:
    'Навчаємо не лише знати правила, а й впевнено користуватися мовою для навчання, карʼєри, подорожей і життя без мовних барʼєрів.',
  cta: 'Записатись на пробне заняття',
} as const

export const STATS = [
  { icon: 'globe', value: 'Online', label: 'з будь-якої точки світу' },
  { icon: 'levels', value: 'A1–C1', label: 'від початку до впевненого спілкування' },
  { icon: 'group', value: '1:1 — 1:6', label: 'індивідуально, у парі або в групі' },
] as const
...
export const DIRECTIONS = [
  {
    ...
    blurb:
      'Живе спілкування та впевненість уже з перших занять — для дітей будь-якого рівня.',
    meta: 'Відкрито',
  ...
  process: [
    {
      ...
      text: 'Підбираємо зручний час та викладача під рівень, ціль, темп',
      tone: 'blush',
    },
    {
      id: 'program',
    ...
    },
    {
      ...
      text: 'Короткі блоки, чіткі цілі заняття та видимий прогрес.',
      tone: 'white',
    },
    {
      id: 'speaking',
      title: 'Sprachklub',
      text: 'Окремі розмовні зустрічі, для практики живої мови, нової лексики та впевненості в спідкуванні.',
      tone: 'graphite',
    },
    {
      id: 'formats',
